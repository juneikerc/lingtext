  ...
  return (
    <section className="relative overflow-hidden border-b border-gray-200 bg-white px-4 py-12">
      <div className="absolute inset-0">
        <div className="absolute left-10 top-10 h-32 w-32 rounded-full bg-[#0F9EDA]/5 blur-3xl]/10"></div>
      ...
      <div className="relative mx-auto max-w-4xl">
        <div className="mb-12 text-center">
          ...
          <h2 className="mb-4 text-4xl font-extrabold text-gray-900 md:text-5xl">
            Tus{" "}
            <span className="text-[#0F9EDA]]">Textos</span>
          </h2>
        ...
        <div className="space-y-6">
          <div className="animate-pulse rounded-2xl border border-gray-200 bg-gray-50 p-6">
            <div className="flex items-center">
              <div className="mr-4 h-10 w-10 rounded-xl bg-gray-200"></div>
            ...
            <div className="space-y-4">
              {[1, 2].map((item) => (
                ...
                >
                  ...
                  <div className="mb-2 h-3 w-1/2 rounded bg-gray-100"></div>
