      ...
      {texts.length > 0 ? (
            ...
            {group.folder ? (
              <details className="group/folder">
                <summary className="list-none cursor-pointer">
                  <div className="mb-3 flex items-center gap-3 rounded-xl border border-gray-200 bg-gray-50 p-3 transition-colors hover:border-gray-300">
                    <span
        ...
        <div className="py-16 text-center">
          ...
          <div className="flex justify-center">
            <button
              className="rounded-xl bg-[#0F9EDA] px-8 py-4 font-semibold text-white shadow-sm transition-colors duration-200 hover:bg-[#0D8EC4] hover:shadow-md"
