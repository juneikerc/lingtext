    ...
    >
      ...
      <div className="bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 p-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">Traducción de frase completa</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4">
          ...
          {selPopup.translations.length > 0 ? (
            <div className="space-y-2 max-h-48 overflow-y-auto">
              {selPopup.translations.map((t, index) => (
                <div
                  key={index}
                  className="bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-lg p-3 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-200"
                >
                  <div className="flex items-start justify-between">
                    ...
                    <div className="ml-2 text-xs text-gray-500 dark:text-gray-400 bg-gray-200 dark:bg-gray-600 px-2 py-1 rounded-full">
                      {index + 1}
                    </div>
                  </div>
                </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-2 border-t border-gray-200 dark:border-gray-700">
          ...
          <button
            className="flex-1 flex items-center justify-center space-x-2 px-4 py-3 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 border border-gray-200 dark:border-gray-600 rounded-lg transition-all duration-200"
            onClick={onClose}
          >
            <span>✕</span>
            <span>Cerrar</span>
