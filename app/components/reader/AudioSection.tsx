          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-3 border-t border-gray-100 pt-2">
            <div className="flex items-center gap-1.5">
              ...
              <button
                ...
                className="inline-flex items-center justify-center w-12 h-12 sm:w-10 sm:h-10 rounded-xl bg-[#0F9EDA] hover:bg-[#0D8EC4] text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0F9EDA] focus-visible:ring-offset-2 focus-visible:ring-offset-white"
            ...
            <div className="ml-auto hidden sm:flex items-center gap-1 text-[11px] text-gray-400">
              ...
              >
                <rect
                  ...
                  strokeWidth="2"
                />
                <path d="M6 8h.01M10 8h.01" strokeWidth="2" strokeLinecap="round" />
              </svg>
              <span>
