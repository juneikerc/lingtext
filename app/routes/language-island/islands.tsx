    ...
    <main className="min-h-screen bg-white">
      <section className="relative overflow-hidden border-b border-gray-200 bg-white px-4 py-16 md:py-24">
        ...
        <div className="relative mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-4xl text-lg leading-relaxed text-gray-600 md:text-xl">
      ...
      <section
        ...
        className="relative overflow-hidden border-b border-gray-200 bg-white py-16 sm:py-20"
      >
        <div className="mx-auto max-w-5xl px-6">
          <header className="max-w-3xl">
            <p className="text-sm font-semibold uppercase tracking-wide text-[#0F9EDA]">
          ...
          <div className="mt-10 space-y-4">
            {FAQS.map((faq) => (
              ...
              >
                <summary className="list-none cursor-pointer text-base font-semibold text-gray-900">
                  {faq.question}
                </summary>
                <p className="mt-3 text-sm leading-relaxed text-gray-600">
                  {faq.answer}
