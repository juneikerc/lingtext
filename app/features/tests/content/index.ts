...
import b2ReadingArgumentosYTrabajoReal from "./b2/reading-argumentos-y-trabajo-real";
import b2VocabularyLenguajeAbstracto from "./b2/vocabulary-lenguaje-abstracto";
import c1DictationRegistroFormal from "./c1/dictation-registro-formal";
import c1GrammarInversionYRelativas from "./c1/grammar-inversion-y-relativas";
import c1ReadingInnovacionYLecturaCritica from "./c1/reading-innovacion-y-lectura-critica";
import c1VocabularyConsensoYMatiz from "./c1/vocabulary-consenso-y-matiz";
import c2DictationAltaPrecision from "./c2/dictation-alta-precision";
import c2GrammarInversionAvanzada from "./c2/grammar-inversion-avanzada";
import c2ReadingClaridadYDiscursoExperto from "./c2/reading-claridad-y-discurso-experto";
import c2VocabularyMatizFino from "./c2/vocabulary-matiz-fino";
...
export const TEST_CATALOG = [
  ...
  b2ReadingArgumentosYTrabajoReal,
  b2GrammarMaticesYLinkers,
  b2VocabularyLenguajeAbstracto,
  b2DictationEstructuraYMatiz,
  c1ReadingInnovacionYLecturaCritica,
  c1GrammarInversionYRelativas,
  c1VocabularyConsensoYMatiz,
  c1DictationRegistroFormal,
  c2ReadingClaridadYDiscursoExperto,
  c2GrammarInversionAvanzada,
  c2VocabularyMatizFino,
  c2DictationAltaPrecision,
];
